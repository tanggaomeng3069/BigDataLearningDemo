...
object ReadHDFSWriteHive {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val spark: SparkSession = SparkSession
            .builder()
            .appName("ReadHDFSWriteHive")
            .master("local[*]")
            .enableHiveSupport()
            .getOrCreate()

        // 示例数据
        val dataRDD: RDD[String] = spark.sparkContext.textFile(KerberosConfigLoader.getString("hdfs.write.hive.path"))
