package com.learning.scalaHanShunPing.chapter17.remotecandymachine.client

import java.rmi.Naming

import com.learning.scalaHanShunPing.chapter17.remotecandymachine.server.CandyMachineRemote
