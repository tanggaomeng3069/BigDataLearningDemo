package com.learning.scalaHanShunPing.chapter17.observer.observepattern

import com.learning.scalaHanShunPing.chapter17.observer.localinternetobserver.WeatherData
